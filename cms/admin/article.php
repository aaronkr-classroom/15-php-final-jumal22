...
$errors = [
    ...
    'summary'    => '',
    'content'    => '',
    'member'     => '', // 'author'에서 로그 에러 원인인 'member'로 수정 완료
    'category'   => '',
    'image_file' => '',
    'image_alt'  => '',
];
    ...
    <div class="admin-article">
      ...
      <section class="text">
        <div class="form-group">
          ...
          <input type="text" name="title" id="title" value="<?= html_escape($article['title']) ?>" class="form-control">
        ...
        <div class="form-group">
          ...
          <span class="errors"><?= $errors['member'] ?></span> </div>
        <div class="form-group">
        ...
        <div class="form-check">
          <input type="checkbox" name="published" value="1" class="form-check-input" id="published" <?= ($article['published'] == 1) ? 'checked' : ''; ?>>
